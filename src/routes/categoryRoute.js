...
router.post('/category', authMiddleware, isAdmin, uploadPhoto.array('image', 1), categoryControllers.createCategory)
...
router.put('/category', authMiddleware, isAdmin, uploadPhoto.array('image', 1), categoryControllers.editCategory)
