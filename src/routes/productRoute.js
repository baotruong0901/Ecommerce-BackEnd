...
router.post('/product', authMiddleware, isAdmin, uploadPhoto.array('images', 10), productControllers.createProduct)
router.put('/product/rating', authMiddleware, productControllers.rating)
router.put('/product/upload/:id', authMiddleware, isAdmin, uploadPhoto.array('images', 10), productControllers.uploadImages)
