...
router.post('/blog', authMiddleware, isAdmin, uploadPhoto.array('image', 1), blogControllers.createBlog)
router.put('/blog', authMiddleware, isAdmin, uploadPhoto.array('image', 1), blogControllers.editBlog)
